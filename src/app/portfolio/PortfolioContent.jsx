      ...
      <section className="bg-[#F5EBE0] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16">
          ...
          <div className="text-center mb-12 md:mb-16">
            <motion.p
              className="text-xs tracking-[0.4em] uppercase text-[#C8972B] mb-4"
              initial={{ opacity: 0 }}
            ...
            <motion.h2
              className="text-4xl md:text-6xl text-[#3D1F0D]"
              style={{
                fontFamily: "'Cormorant Garamond', serif",
              }}
              initial={{ opacity: 0, y: 20 }}
            ...
            <motion.div
              className="w-24 h-[2px] bg-[#C8972B] mx-auto mt-6"
              initial={{ width: 0 }}
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {featuredProjects.map((project, i) => (
              ...
              >
                <Link href={`/portfolio/${project.slug}`}>
                  <div className="group relative overflow-hidden bg-white border border-[#3D1F0D]/10 hover:border-[#C8972B]/40 transition-all duration-500 shadow-sm hover:shadow-xl hover:shadow-[#C8972B]/10">
                    {/* Image */}
                    <div className="relative h-[300px] md:h-[420px] overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-[#3D1F0D]/0 group-hover:bg-[#3D1F0D]/35 transition-all duration-500" />

                      {/* Type Badge */}
                      <div className="absolute top-4 left-4 px-3 py-2 bg-white/90 backdrop-blur-sm text-[10px] tracking-[0.3em] uppercase text-[#3D1F0D] font-semibold">
                        {project.type}
                      </div>

                      {/* Hover Button */}
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                        <span className="border border-[#C8972B] px-6 py-3 text-[#C8972B] uppercase tracking-[0.2em] text-xs bg-white/10 backdrop-blur-md">
                          View Project
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-6">
                      <h3
                        className="text-2xl text-[#3D1F0D] mb-2 group-hover:text-[#C8972B] transition-colors"
                        style={{
                          fontFamily: "'Cormorant Garamond', serif",
                        }}
                      >
                      ...
                      <p className="text-sm tracking-wider text-[#3D1F0D]/60">
                        {project.location} • {project.bhk}
                      </p>
                    </div>

                    {/* Bottom Line */}
                    <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-[#C8972B] group-hover:w-full transition-all duration-500" />
                  </div>
                </Link>
              </motion.div>
            ))}
