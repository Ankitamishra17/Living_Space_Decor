  ...
  return (
    <section className="px-6 lg:px-14 py-12">
      ...
      <div className="relative overflow-hidden group/marquee">
        {/* edge fades */}
        {/* <div className="pointer-events-none absolute inset-y-0 left-0 w-10 md:w-18 z-20 bg-gradient-to-r from-white to-transparent" /> */}
        {/* <div className="pointer-events-none absolute inset-y-0 right-0 w-10 md:w-18 z-20 bg-gradient-to-l from-white to-transparent" /> */}
